...
const blogPosts = [
  {
    slug: "top-5-luxury-experiences-dubai",
    ...
    imageUrl: getLocalImage("luxury", 0),
    imageHint: "dubai skyline luxury",
    author: "Jane Doe",
    category: "Travel Guides",
    readTime: "5 min read",
  },
  {
    slug: "choosing-perfect-vacation-rental",
    title: "How to Choose the Perfect Vacation Rental for Your Needs",
    date: "October 15, 2023",
    excerpt:
      "Finding the ideal home away from home can be daunting. Here are our expert tips for selecting a vacation rental that ticks all your boxes...",
    imageUrl: getLocalImage("property", 0),
    imageHint: "luxury interior planning",
    author: "John Smith",
    category: "Tips & Advice",
    readTime: "8 min read",
  },
  {
    slug: "expat-living-guide-uae",
    title: "A Beginner's Guide to Expat Living in the UAE",
    date: "September 30, 2023",
    excerpt:
      "Moving to the UAE? Our comprehensive guide covers everything you need to know for a smooth transition to expat life...",
    imageUrl: getLocalImage("villa", 2),
    imageHint: "uae culture cityscape",
    author: "Admin",
    category: "Lifestyle",
    readTime: "12 min read",
  },
  {
    slug: "luxury-property-management-tips",
    title: "Essential Tips for Luxury Property Management",
    date: "September 15, 2023",
    excerpt:
      "Learn the secrets of successful luxury property management from industry experts and experienced professionals...",
    imageUrl: getLocalImage("property", 1),
    imageHint: "property management luxury",
    author: "Sarah Wilson",
    category: "Property Management",
    readTime: "6 min read",
  },
  {
    slug: "dubai-marina-living-guide",
    title: "The Ultimate Guide to Living in Dubai Marina",
    date: "August 28, 2023",
    excerpt:
      "Everything you need to know about living in one of Dubai's most prestigious waterfront communities...",
    imageUrl: getLocalImage("villa", 1),
    imageHint: "dubai marina waterfront",
    author: "Michael Chen",
  ...
  },
  {
    ...
    title: "Sustainable Luxury: The Future of High-End Travel",
    date: "August 10, 2023",
    excerpt:
      "Discover how luxury travel is evolving to embrace sustainability without compromising on comfort and elegance...",
    imageUrl: getLocalImage("luxury", 1),
    imageHint: "sustainable luxury travel",
